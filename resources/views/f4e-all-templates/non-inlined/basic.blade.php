                        ...
                        <tbody>
                          <tr>
                            <th class="small-6 large-6 columns first">
                              <table>
                                <tr>
                                  <th> <img src="@yield('navImgHref')"> </th>
                                </tr>
                              </table>
                            </th>
                            <th class="small-6 large-6 columns last">
                              <table>
                                <tr>
                                  <th>
                                    <p class="text-right">@yield('navText')</p>
                                  </th>
                                </tr>
                              </table>
                            </th>
                        ...
                        <tr>
                          <th class="small-12 large-12 columns first last">
                            <table>
                              <tr>
                                <th> <br>
                                  <center data-parsed=""> <img src="@yield('bodyImgHref')" align="center" class="text-center"> </center> <br>
                                  <h1>@yield('header')</h1>
                                  <p class="lead">@yield('subHeader')</p>
                                  <p>@yield('bodyContent')</p>
                                  <table class="callout">
                                    <tr>
                                      <td class="callout-inner primary">
                                        <p>@yield('bodySubContent')</p>
                                      </td>
